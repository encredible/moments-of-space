...
const portfolioItemsData: Record<string, PortfolioItemDetail> = {
  "modern-apartment-makeover": {
    id: "modern-apartment-makeover",
    title: "Modern Apartment Makeover",
    category: "Residential",
    imageUrl: "/images/portfolio/portfolio-modern-apartment-detail1.jpg",
    ...
    images: [
      { src: "/images/portfolio/portfolio-modern-apartment-detail1.jpg", alt: "Living room view after makeover" },
      { src: "/images/portfolio/portfolio-modern-apartment-detail2.jpg", alt: "Modern kitchen design" },
      { src: "/images/portfolio/portfolio-modern-apartment-detail3.jpg", alt: "Bedroom with custom wardrobe" },
    ],
    testimonial: {
  ...
  "cozy-living-room-refresh": {
    ...
    category: "Residential",
    imageUrl: "/images/portfolio/portfolio-cozy-living-detail2.jpg",
    ...
    images: [
      { src: "/images/portfolio/portfolio-cozy-living-detail1.jpg", alt: "Refreshed living room with new furniture" },
      { src: "/images/portfolio/portfolio-cozy-living-detail2.jpg", alt: "Close up of cozy textures and decor" },
    ],
    testimonial: {
  ...
  "luxury-villa-design": {
    ...
    category: "Residential",
    imageUrl: "/images/portfolio/portfolio-luxury-villa-detail1.jpg",
    ...
    images: [
      { src: "/images/portfolio/portfolio-luxury-villa-detail1.jpg", alt: "Villa exterior with infinity pool" },
      { src: "/images/portfolio/portfolio-luxury-villa-detail2.jpg", alt: "Spacious living area with ocean view" },
    ],
    testimonial: {
  ...
  "minimalist-office-space": {
    ...
    images: [
      { src: "/images/portfolio/portfolio-modern-apartment-detail3.jpg", alt: "Open concept office with natural light" },
      { src: "/images/portfolio/portfolio-luxury-villa-detail2.jpg", alt: "Collaborative meeting area" },
    ],
    testimonial: {
  ...
  "bohemian-bedroom-retreat": {
    ...
    category: "Residential",
    imageUrl: "/images/portfolio/portfolio-boho-bedroom.jpg",
    ...
    images: [
      { src: "/images/portfolio/portfolio-boho-bedroom-detail1.jpg", alt: "Bohemian bedroom with layered textiles" },
      { src: "/images/portfolio/portfolio-boho-bedroom-detail2.jpg", alt: "Close up of eclectic decor elements" },
    ],
    testimonial: {
  ...
  "sleek-kitchen-remodel": {
    ...
    category: "Residential",
    imageUrl: "/images/portfolio/portfolio-sleek-kitchen.jpg",
    ...
    images: [
      { src: "/images/portfolio/portfolio-sleek-kitchen-detail1.jpg", alt: "Modern kitchen with high-gloss cabinets" },
      { src: "/images/portfolio/portfolio-sleek-kitchen-detail2.jpg", alt: "Kitchen island with integrated appliances" },
    ],
    testimonial: {
...
const PortfolioDetailPage: React.FC<PortfolioDetailPageProps> = ({ params }) => {
  const { id } = use(params);
  const item = portfolioItemsData[id];
