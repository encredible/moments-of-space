...
const Footer: React.FC = () => {
  return (
    <footer className="w-full py-12">
      <div className="max-w-screen-xl px-5 sm:px-10">
        <div className="flex flex-col">
          ...
          {/* 인스타그램 아이콘 */}
          <div className="mb-8">
            <a href={typedFooterContent.instagram_link} target="_blank" rel="noopener noreferrer" aria-label="Instagram">
