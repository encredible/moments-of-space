    ...
    <footer className="border-t border-gray-200 w-full mt-auto">
      <div className="max-w-screen-xl mx-auto flex flex-col items-center px-5 py-8 sm:px-10 gap-6">
        <div className="flex justify-center items-center flex-wrap gap-x-8 sm:gap-x-12 gap-y-4">
          <Link href="/contact" className="font-korean text-base text-gray-500 hover:text-neutral-700 text-center">Contact</Link>
          <Link href="/privacy-policy" className="font-korean text-base text-gray-500 hover:text-neutral-700 text-center">Privacy Policy</Link>
          <Link href="/terms-of-service" className="font-korean text-base text-gray-500 hover:text-neutral-700 text-center">Terms of Service</Link>
        </div>
        ...
        <div className="flex flex-col items-center">
          <p className="font-korean text-sm text-gray-500 text-center">
